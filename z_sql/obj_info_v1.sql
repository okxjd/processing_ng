...
select distinct
    nvl(o.cad_num, o.cad_num_num) as "Кадастровый номер",
    kk.cad_num as "квартал",
...
-- */
-- /* ОКН
    vsocl.name "Статус ОКН",
    ocl.name "Наименование ОКН",
    ocl.reg_num_reestr "Номер в реестре ОКН"
-- */
